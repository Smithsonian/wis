"""
    ...
    The data for each obs-code is specified in a "KernelManager" object
    
    Each KernelManager-Object is saved into an overall
    obscodeDict
...
TESS = KernelSpecifier(
    obscode        = '-95',
    name           = 'TESS',
    files          = ['https://archive.stsci.edu/missions/tess/models/tess2018338154046-41240_naif0012.tls',
...
K2 = KernelSpecifier(
    obscode          = '-227',
    name             = 'K2',
    files            = ['https://archive.stsci.edu/pub/k2/spice/kplr2018134232543.tsc',
...
# --------------------------------------------------------------------------
CASSINI = KernelSpecifier(
    obscode          = '-82',
    name             = 'CASSINI',
    files            = ['https://naif.jpl.nasa.gov/pub/naif/generic_kernels/lsk/a_old_versions/naif0009.tls',
...
# --------------------------------------------------------------------------
satellite_obscode_dict = {KS.obscode:KS for KS in [TESS, K2, CASSINI]}
